...
//            setTimer()
//        } else {
//            interval = Interval(date: Date(), unit: .day, includeTime: false, description: descriptionLabel.text!, creationDate: Date())
...
//    }
//    func saveData() {
//        DataManager.main.saveUserData(interval)
//        if let _ = session {
//            sendDataToWatch()
//        }
//        if timer == nil {
...
//        let count = DataManager.openCount()
//        if count > 5 {
//            let rateStatus = DataManager.rateStatus()
//            
//            switch rateStatus {
//            case .unseen:
//                present(rateAlert1, animated: true, completion: nil)
//            case .deferredForNextTime:
//                DataManager.update(rateStatus: .deferredForNow)
//            case .deferredForNow:
...
//            DataManager.update(rateStatus: .acceptedRequest)
//            self.rateApp()
//        }
//        let actionLater = UIAlertAction(title: "Later", style: UIAlertActionStyle.default) { _ in
//            DataManager.update(rateStatus: .deferredForNextTime)
//        }
//        let actionNo = UIAlertAction(title: "No", style: .default) { _ in
//            DataManager.update(rateStatus: .rejectedRequest)
//        }
